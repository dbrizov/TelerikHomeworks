...
var snakeGame = (function () {
    ...
    var SnakeGame = Class.create({
        ...
        _checkCollisionsWithSideWalls: function () {
            var i;
        ...
        _checkCollsisionsWithGameObjects: function () {
            for (var i = 0; i < this.gameObjects.length; i += 1) {
                ...
                if (!(gameObject instanceof Snake)) {
                    ...
                    if (colliding && (gameObject instanceof SnakePiece)) {
                        this.snake.consume(gameObject);
                    }
                }
            }
        ...
        checkCollisions: function () {
            this._checkCollisionsWithSideWalls();
            this._checkCollsisionsWithGameObjects();
        },
