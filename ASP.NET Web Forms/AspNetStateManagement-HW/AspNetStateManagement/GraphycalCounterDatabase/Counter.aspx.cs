...
namespace AspNetStateManagement.GraphycalCounterDatabase
{
    public partial class Counter : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var dbContext = new VisitorsCounterDbEntities();
            using (dbContext)
            {
                dbContext.VisitorsCounters.ToList()[0].Count += 1;
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            var dbContext = new VisitorsCounterDbEntities();
            string sCaptchaText = dbContext.VisitorsCounters.ToList()[0].Count.ToString();
            ...
            Bitmap counterImage = (Bitmap)tc.ConvertFrom(oBytes);

            counterImage.Save(this.Response.OutputStream, ImageFormat.Jpeg);
        }
    }
}