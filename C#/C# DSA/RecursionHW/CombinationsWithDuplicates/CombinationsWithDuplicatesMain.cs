...
namespace CombinationsWithDuplicates
{
    public class CombinationsWithDuplicatesMain
    {
        public static void Main(string[] args)
        {
            ...
            GenerateCombinationsWithDuplications(arr, set, 0, 0);
        }

        /// <summary>
        /// Generates all the combinations with duplicates of K elements from N element set
        /// </summary>
        ...
        /// <param name="combIndex">The index that walks through the currentCombination</param>
        /// <param name="setIndex">The index that walks through the set</param>
        public static void GenerateCombinationsWithDuplications(int[] currentCombination, int[] set, int combIndex, int setIndex)
        {
            ...
            else
            {
                for (int i = setIndex; i < set.Length; i++)
                {
                    ...
                    GenerateCombinationsWithDuplications(currentCombination, set, combIndex + 1, i);
                }
            }
        }
