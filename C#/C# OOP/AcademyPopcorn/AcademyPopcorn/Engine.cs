...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        protected int gameSleepTime; // Exercise 2 - create a gameSleepTime variable and edit the Engine constructor

        public Engine(IRenderer renderer, IUserInterface userInterface, int gameSleepTime)
        {
            ...
            this.gameSleepTime = gameSleepTime;
        }
        ...
        private void AddRacket(GameObject obj)
        {
            ...
            foreach (var item in this.staticObjects)
            {
                if (item is Racket)
                {
        ...
        public virtual void Run()
        {
            while (true)
            {
                ...
                System.Threading.Thread.Sleep(this.gameSleepTime);
